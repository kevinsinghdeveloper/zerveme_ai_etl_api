...
from controllers.auth.AuthenticationController import \
    AuthenticationController
from controllers.report_processor.ReportProcessorController import \
...
report_processor_resource_manager = ReportProcessorResourceManager(
    {"etl_service_manager": etl_service_manager})
auth_resource_manager = AuthenticationResourceManager()

# register controllers
register_controller(app, ReportProcessorController,
                    report_processor_resource_manager)
